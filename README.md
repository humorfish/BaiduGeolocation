...
```bash
$ cordova plugin add https://github.com/humorfish/BaiduGeolocation.git --variable API_KEY=百度分配的AK --save
```
...
...
  ...
  <platform name="android">
    <plugin name="cordova-plugin-baidu-geolocation" spec="https://github.com/humorfish/BaiduGeolocation">
